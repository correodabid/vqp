...
program.name('vqp-zk').description('VQP Zero-Knowledge Proof CLI').version('1.0.0');
...
program
  ...
  .action(() => {
    ...
    console.log(
      '   vqp-zk prove -c age_verification -i \'{"age": 25}\' -p \'{"threshold": 18}\'\n'
    );
    ...
    console.log(
      '   vqp-zk prove -c income_verification -i \'{"income": 75000}\' -p \'{"threshold": 50000}\' --config ./my-circuits/config.json\n'
    );
  });
